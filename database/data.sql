...
INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (9, 'Crash when starting game', 'Whenever I try to start the game, it crashes immediately. I have tried uninstalling and reinstalling, but the issue persists. Any suggestions?', '2022-03-10 02:18:42', 'public', '2-high', 'new', 'Technical support', NULL, 9, NULL);
INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (10, 'Overwatch server down', "I can't connect to the Overwatch servers. Is there a problem with them?", '2023-04-14 06:27:12', 'public', '1-critical', 'new', 'Technical support', NULL, 10, NULL);

INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (11, 'Super Mario Bros. level bug', 'In world 5-2, there is a glitch where Mario gets stuck in the wall. Please fix!', '2023-04-23 17:52:21', 'public', '1-critical', 'closed', 'Gameplay issues', NULL, 11, 77);
...
INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (33, 'Toxic player in chat', "There's a player in the chat who keeps using offensive language and making other players uncomfortable. Can you do something about this?", '2023-04-17 06:51:53', 'public', '1-critical', 'solved', 'Community management', 11, 33, 88);
...
INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (49, 'Team disqualification from tournament', 'Our team was disqualified from the esports tournament and we are not sure why. Can someone please provide more information?', '2022-04-15 05:54:08', 'public', '2-high', 'new', 'Esports and tournaments', NULL, 49, NULL);
INSERT INTO Ticket (id, title, text, createDate, visibility, priority, status, category, frequentItem, creator, replier) VALUES (50, 'Streaming issues during tournament', 'There were streaming issues during the esports tournament and many viewers could not watch the games. Can someone please look into this?', '2022-05-01 11:22:37', 'public', '3-medium', 'new', 'Esports and tournaments', NULL, 50, NULL);
